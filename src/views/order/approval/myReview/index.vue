...
import { getMyReviewList, type MyReviewParams, type OrderParams } from "@/api/order"
import { getCodeName, resetFields } from "@/utils"
import { columns, formatTableFun } from "./myReview"
...
const searchForm = ref<MyReviewParams>({
  request_user_id: localStorage.getItem("user_id"),
  type: "",
  status: 1,
  po: "",
  customer: ""
